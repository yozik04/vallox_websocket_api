...
class TestValloxSetProfile(asynctest.TestCase):
  ...
  async def testSetProfileHome(self):
    await self.checkSetProfile(PROFILE.HOME, {'A_CYC_STATE': '0',
                                        'A_CYC_BOOST_TIMER': '0',
                                        'A_CYC_FIREPLACE_TIMER': '0',
                                        'A_CYC_EXTRA_TIMER': '0'})

  async def testSetProfileAway(self):
    await self.checkSetProfile(PROFILE.AWAY, {'A_CYC_STATE': '1',
                                        'A_CYC_BOOST_TIMER': '0',
                                        'A_CYC_FIREPLACE_TIMER': '0',
                                        'A_CYC_EXTRA_TIMER': '0'})
  ...
  async def testSetProfileBoost(self):
    ...
    await self.checkSetProfile(PROFILE.BOOST, {'A_CYC_BOOST_TIMER': '30',
                                         'A_CYC_FIREPLACE_TIMER': '0',
                                         'A_CYC_EXTRA_TIMER': '0'})
  ...
  async def testSetProfileFireplace(self):
    ...
    await self.checkSetProfile(PROFILE.FIREPLACE, {'A_CYC_BOOST_TIMER': '0',
  ...
  async def testSetProfileExtra(self):
    ...
    await self.checkSetProfile(PROFILE.EXTRA, {'A_CYC_BOOST_TIMER': '0',
                                             'A_CYC_FIREPLACE_TIMER': '0',
